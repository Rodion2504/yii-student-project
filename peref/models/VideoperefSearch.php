...
/**
 * VideoperefSearch represents the model behind the search form of `frontend\models\Videoperef`.
 */
class VideoperefSearch extends Videoperef
{
    /**
     * {@inheritdoc}
     */
