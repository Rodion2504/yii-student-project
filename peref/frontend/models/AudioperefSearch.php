...
/**
 * AudioperefSearch represents the model behind the search form of `frontend\models\Audioperef`.
 */
class AudioperefSearch extends Audioperef
{
    /**
     * {@inheritdoc}
     */
